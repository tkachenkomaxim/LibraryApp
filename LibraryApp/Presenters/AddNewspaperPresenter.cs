...
{
    class AddNewspaperPresenter
    {
        private IAddNewspaperView _form;
        private Library _library;

        public AddNewspaperPresenter(IAddNewspaperView form, Library library)
        {
            _form = form;
            _library = library;
            _form.AddNewspaper += Form_AddNewspaper;
        }
